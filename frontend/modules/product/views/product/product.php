                    ...
                    <div class="flexslider">
                        <ul class="slides">
                            ...
                            <li data-thumb="images/s1.jpg">
                                <div class="thumb-image detail_images"> <img src="<?= \yii\helpers\Url::to('@web/images/'.$image) ?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
                            </li>
                            <?php
                            ?>
                        </ul>
                    ...
                    <div class="single-price">
                        <ul>
                            ...
                            if(!empty($prod['sale_price'])){
                                ?>
                                <li style="text-decoration: line-through; font-size: 20px">$<?= $prod['price'];?></li> <li style="font-size: 40px"><?= $prod['sale_price'];?></li>
                                <?php
                            }else{
                                ?>
